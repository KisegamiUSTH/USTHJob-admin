...
import com.usth.jobadmin.model.Admin
import com.usth.jobadmin.util.Constants.Companion.COLLECTION_PATH_ADMIN
    ...
    fun login(email: String, password: String) {
        viewModelScope.launch(IO) {
            try {
                ...
                val userRef = mFirestore.collection(COLLECTION_PATH_SUP).document(userId)
