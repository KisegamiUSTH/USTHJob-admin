...
import com.usth.jobadmin.auth.viewmodel.AuthViewModel
import com.usth.jobadmin.databinding.FragmentLoginBinding
import com.usth.jobadmin.home.HomeActivity
            ...
            when (resource.status) {
                ...
                SUCCESS -> {
                    ...
                    if (user.roleType == args.roleType) {
                        if (user.userInfoExist.not() && user.roleType == ROLE_TYPE_SUP) {
                            navigateToUserDetail(username = user.username, email = user.email)
                        } else if (user.userInfoExist && user.roleType == ROLE_TYPE_SUP) {
