package com.usth.jobadmin.home.fragment.homeFragment
...
import com.usth.jobadmin.databinding.BottomSheetLogoutBinding
import com.usth.jobadmin.databinding.FragmentHomeBinding
import com.usth.jobadmin.home.fragment.homeFragment.viewmodel.HomeViewModel
import com.usth.jobadmin.util.Constants.Companion.ROLE_TYPE_ADMIN
import com.usth.jobadmin.util.LoadingDialog
import com.usth.jobadmin.util.Status.*
import com.usth.jobadmin.util.getGreeting
    ...
    private fun setupUI() {
        with(binding)  {
            ...
            cvPlacementOfficer.setOnClickListener {
                findNavController().navigate(R.id.action_homeFragment_to_supFragment)
            }
        }
    }
            ...
            when (resource.status) {
                ...
                SUCCESS -> {
                    ...
                    if (binding.cvPlacementOfficer.visibility == View.VISIBLE){
                        counterAnimation(counts.supCount, binding.tvPlacementOfficerCount)
                    }
