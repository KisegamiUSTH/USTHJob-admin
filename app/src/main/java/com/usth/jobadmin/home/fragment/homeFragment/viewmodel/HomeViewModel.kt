package com.usth.jobadmin.home.fragment.homeFragment.viewmodel
...
import com.usth.jobadmin.util.Constants.Companion.COLLECTION_PATH_NOTIFICATION
    ...
    fun fetchCounts() {
        viewModelScope.launch(IO) {
            try {
                ...
                val supCount = getCount(COLLECTION_PATH_SUP)
                ...
                val count = Counts(supCount, studentCount, jobCount, mockCount, notificationCount)
